...
<div class="container">
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          ...
          <a href="http://www.vcsglobal.co.in"><img src="assets\img\icon\vcsicon.png" width="130" height="130" title="Visit website" alt="Logo of a company" /></a>
          <br></br>
          <h2>Welcome to VCS Global</h2>
          <p>
            <a href="registration.php">Sign up Now! </a> for a VCS Global account, it's free and always will be.</p>
          <br>
