...
<meta charset="utf-8" />
<title>CRM | Create Profile</title>
  ...
  <div class="page-content"> 
    ...
    <div class="content">  
		<div class="page-title">	
			<h3>Create New Candidate Profile</h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <p>Please fill all the below mentioned requied information to ceate a new candidate profile:</p>
                                </div>
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">                                        
                                                <label class="col-md-3 control-label">Prev. Employer</label>
                                                <div class="col-md-9 col-xs-12">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="contact" class="form-control" required/>
                                            ...
                                            <div class="form-group">
                                             <label class="col-md-3 control-label">Service Type</label><br>
                                               
                                            <div class="col-md-9">                                                                                                                        
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="wdnd" value="Website Design & Development" checked="checked"/>Paid</label>
                                             <label class="check">
                                             <input type="checkbox" class="icheckbox" name="seo" value="SEO (Search Engine Optimization)" />Unpaid	</label><br>
                                       ...
                                       <div class="form-group">                                        
                                                <label class="col-md-3 control-label">Total Working Exp.</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="company" placeholder = "In Months" class="form-control datepicker" value="" required>                                            
                                                    </div>
